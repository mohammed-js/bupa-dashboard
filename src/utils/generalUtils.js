...
المتعلقة بالمزايا والحدود والإستثناءات المطبقة على خطة التأمين الخاصة بك في كتيب المزايا واالإستثناءات. 
  
نؤكد بموجب هذه الوثيقة أن الأشخاص المذكورين أدناه عملاء بخطة بوبا إيجيبت للتأمين الطبي. تغطي الخطة التأمينية تكاليف
العالج المستحق تكاليف الإقامة في المستشفى وتكاليف العلاج الفعال بحد سنوي أقصى قدره ${max} ${currency}
